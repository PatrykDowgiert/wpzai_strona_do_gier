...
const games = [
  ...
  { id: 21, name: 'Flappy Bird', category: 'Zręcznościowe', image: '/FLAPPYBIRD.png', url: 'https://flappybird.io', description: 'Kultowa gra polegająca na przeprowadzeniu ptaka przez wąskie szczeliny między rurami. Prosta w obsłudze, ale niezwykle trudna do opanowania.' },
  { id: 22, name: 'Sudoku', category: 'Puzzle', image: '/SUDOKU.png', url: 'https://sudoku.com', description: 'Klasyczna gra logiczna polegająca na wypełnianiu siatki 9x9 cyframi od 1 do 9. Świetnie trenuje logiczne myślenie.' },
  { id: 23, name: 'Paper.io 2', category: 'Akcja', image: '/PAPERIO2.png', url: 'https://paper-io.com', description: 'Zdobądź jak największe terytorium na planszy. Rysuj linie i zamykaj obszary, ale uważaj na innych graczy!' },
  { id: 24, name: 'Hole.io', category: 'Akcja', image: '/HOLEIO.png', url: 'https://hole-io.com', description: 'Steruj czarną dziurą pochłaniającą obiekty w mieście. Im więcej pochłoniesz, tym większa się stajesz!' },
  { id: 25, name: 'Among Us Online', category: 'Akcja', image: '/AMONGUSONLINE.png', url: 'https://www.crazygames.com/game/among-us-online-edition', description: 'Przeglądarkowa wersja kultowej gry społecznej. Wykonuj zadania i szukaj ukrytego zdrajcy!' },
  { id: 26, name: 'Retro Bowl', category: 'Sport', image: '/RETROBOWL.png', url: 'https://www.crazygames.com/game/retro-bowl', description: 'Futbolowa gra w stylu retro pixel art. Zarządzaj drużyną i rozgrywaj mecze.' },
  { id: 27, name: 'Chess.com', category: 'Puzzle', image: '/CHESSCOM.png', url: 'https://www.chess.com/play', description: 'Najpopularniejsza platforma szachowa. Graj przeciwko komputerowi lub innym graczom.' },
  { id: 28, name: 'Lichess', category: 'Puzzle', image: '/LICHESS.png', url: 'https://lichess.org', description: 'Całkowicie darmowa platforma szachowa open source. Turnieje, lekcje i zaawansowana analiza partii.' },
  { id: 29, name: 'Minesweeper', category: 'Puzzle', image: '/MINESWEEPER.png', url: 'https://minesweeper.online', description: 'Klasyczna gra logiczna - odkrywaj pola bez trafienia na minę. Trenuje dedukcję.' },
  { id: 30, name: '2048 Cupcakes', category: 'Puzzle', image: '/2048CUPCAKES.png', url: 'https://www.crazygames.com/game/2048-cupcakes', description: 'Słodka wersja 2048 z babeczkami zamiast cyfr. Łącz babeczki, tworząc nowe wypieki!' },
  { id: 31, name: 'Splix.io', category: 'Akcja', image: '/SPLIXIO.png', url: 'https://splix.io', description: 'Podbijaj terytorium na planszy. Wracaj do swojego obszaru, aby go powiększyć, ale nie daj się złapać!' },
  { id: 32, name: 'Tanki Online', category: 'Akcja', image: '/TANKIONLINE.png', url: 'https://tankionline.com', description: 'Przeglądarkowa gra czołgowa multiplayer. Walcz, zdobywaj punkty i ulepszaj swój czołg.' },
  { id: 33, name: 'Powerline.io', category: 'Akcja', image: '/POWERLINEIO.png', url: 'https://powerline.io', description: 'Neonowa wersja Snake. Steruj świetlistą linią, rosnij i eliminuj innych graczy.' },
  { id: 34, name: 'Lordz.io', category: 'Strategia', image: '/LORDZIO.png', url: 'https://lordz.io', description: 'Strategiczna gra multiplayer. Buduj średniowieczne królestwo, rekrutuj wojska i atakuj wrogów.' },
  { id: 35, name: 'Surviv.io', category: 'Akcja', image: '/SURVIVIO.png', url: 'https://surviv.io', description: 'Przeglądarkowe battle royale w widoku z góry. Zbieraj broń i bądź ostatnim survivorem!' },
  { id: 36, name: 'Zombs Royale', category: 'Akcja', image: '/ZOMBSROYALE.png', url: 'https://zombsroyale.io', description: 'Kolorystyczna gra battle royale. Skacz na mapę, zbieraj broń i walcz o przetrwanie.' },
];
