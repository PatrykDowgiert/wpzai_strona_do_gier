...
const games = [
  ...
  { id: 25, name: 'Among Us Online', category: 'Akcja', image: '/AMONGUSONLINE.png', url: 'https://amongus-online.net/', description: 'Przeglądarkowa wersja kultowej gry społecznej. Wykonuj zadania i szukaj ukrytego zdrajcy!' },
  { id: 26, name: 'Retro Bowl', category: 'Sport', image: '/RETROBOWL.png', url: 'https://www.crazygames.com/game/big-hit-football', description: 'Futbolowa gra w stylu retro pixel art. Zarządzaj drużyną i rozgrywaj mecze.' },
